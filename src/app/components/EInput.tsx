  ...
  'py-1 px-2 flex rounded gap-1 items-center transition duration-200',
  {
    variants: {
      variant: {
        ...
        neubrutalism:
          'border border-zinc-700 rounded-sm shadow-[2px_2px_0px_rgb(82,82,91)] dark:shadow-[2px_2px_0px_rgb(113,113,122)] focus-within:bg-yellow-50 dark:focus-within:bg-zinc-700/100',
        // with floating label
      },
      size: {
        sm: 'h-8',
